function output = runprogram(params, monitor)

%%% Variables to change manually
load data.mat data  % Load model and data from MAT file

groupVariableName       = "ID";
independentVariableName = "Time";
dependentVariableName   = "Conc";
doseTargets             = ["Drug_Central", "Dose_Central"];
doseDataColumns         = ["IVDose", "EVDose"];
covariateSeparator      = "__";
%%%
