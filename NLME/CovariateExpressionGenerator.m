classdef CovariateExpressionGenerator < handle
    ...
    methods
        ...
        function addCovariateExpression(obj, parametername, options)
            ...
            covariateExpression = replace(covariateExpression, "theta_i", "theta_" + obj.CovExpIndex);
            covariateExpression = replace(covariateExpression, "eta_i", "eta_" + obj.CovExpIndex);

            % add to list of covariate expressions
            obj.CovariateExpression{obj.CovExpIndex} = char(covariateExpression);
            obj.CovExpIndex = obj.CovExpIndex + 1;
